...
public class KeyboardAndMouseAction extends BaseClass {
	...
	public void DoubleClick() {
		...
		WebElement DoubleClickButt = driver.findElement(By.id("doubleClickBtn"));

		// Double Click
		act.contextClick(DoubleClickButt).build().perform();
		WebElement AfterClick = driver.findElement(By.id("doubleClickBtn"));
